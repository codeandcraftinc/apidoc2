...
require([
    ...
    'pathToRegexp',
    'list'
], function($, _, locale, Handlebars, apiProject, apiData, prettyPrint, sampleRequest, semver, versionsUtil, WebFont) {
    ...
    apiVersions.sort(versionsUtil.compare);
    ...
    $('#versions li.version a').on('click', function(e) {
        ...
        $('article[data-version]').each(function(index) {
            ...
            if (versionsUtil.lte(version, selectedVersion)) {
